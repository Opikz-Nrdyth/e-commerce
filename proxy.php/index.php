...
header('Access-Control-Allow-Headers: Content-Type, Authorization, X-Proxy-URL');
...
file_put_contents("header_log.json", json_encode($_SERVER));
...
if ('POST' == $request_method) {
	...
	if ($isMultiPart) {
		...
		// Gabungkan normal form data dengan file
		$post_data = array_merge($post_data, $file_params);

		curl_setopt($ch, CURLOPT_POST, true);
		curl_setopt($ch, CURLOPT_POSTFIELDS, $post_data);
	}
	// Jika raw data (JSON, dll)
	else {
